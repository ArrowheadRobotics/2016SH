...
public class Robot extends IterativeRobot {
    ...
    RobotMap.init();
        ...
        def.addObject("Rough Terrain", 7);
        def.addObject("Low Bar", 8);
        ...
        //NewAutonomous = new NewAutonomous();
    ...
    public void autonomousInit() {
    	...
    	NewAutonomous = (Command) Robot.def.getSelected();
    	if (NewAutonomous != null) NewAutonomous.start();
