...
public class RobotMap {
    ...
    //Encoders
    public static AnalogInput leftDriveEnc;
    public static AnalogInput rightDriveEnc;
    ...
    public static void init() {
        ...
        //ENCODERS
        leftDriveEnc = new AnalogInput(Constants.Encoders.LEFT_ENC_PORT);
        rightDriveEnc = new AnalogInput(Constants.Encoders.RIGHT_ENC_PORT);
    }
}
